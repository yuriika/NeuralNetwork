...
namespace NeuralNetwork.Testings
{
    public static class Test_SimpleNetwork
    {
        [TestMethod]
        public static void Test_SimpleNetwork_1()
        {
            ...
            // Configure weights and bias for output node
